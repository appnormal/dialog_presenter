...
import 'package:dialog_presenter/src/platform_alert_dialog.dart';

import 'ios_date_time_picker.dart';
import 'radio_button_dialog.dart';
...
class DialogPresenter extends StatefulWidget {
  static DialogPresenterState of(BuildContext context) {
  ...
  @override
  State<DialogPresenter> createState() => DialogPresenterState();
}

class DialogPresenterState extends State<DialogPresenter> {
...
class DialogPresenterData extends InheritedWidget {
  final DialogPresenterState? data;

  const DialogPresenterData({
    super.key,
    this.data,
